...
export function RecruiterDetailDrawer({ recruiter, onClose }: RecruiterDetailDrawerProps) {
  ...
  return (
    <>
          ...
          <Stack direction="row" alignItems="center" spacing={2}>
            ...
            <Box sx={{ flex: 1, minWidth: 0 }}>
              <Stack direction="row" spacing={1} alignItems="center">
                <BusinessCenterIcon sx={{ fontSize: 14, color: "#34d399" }} />
                <Typography variant="overline" sx={{ color: "#34d399", lineHeight: 1, fontSize: "0.65rem" }}>
                  Recruiter
                </Typography>
              </Stack>
          ...
          {result && (
            <Stack direction="row" spacing={1.5} sx={{ mt: 2 }}>
              <Chip
                ...
                sx={{ bgcolor: alpha("#34d399", 0.12), color: "#34d399", fontWeight: 600 }}
              />
              {recruiter?.createdAt && (
                <Chip
                  size="small"
      ...
      {/* Edit dialog — rendered outside Drawer so it isn't clipped */}
      <EditJobDialog
        job={editTarget}
