...
// // Map display labels â†’ API enum values
...
// // Map experience string â†’ API ExperienceLevel
...
// // â”€â”€â”€ Form shape (matches original UI exactly) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// interface Props {
//   open: boolean;
//   onClose: () => void;      // called on cancel / X â€” no refresh
//   onSuccess: () => void;    // called after successful publish â€” triggers dashboard refresh + toast
// }
...
//   // AI Assist â€” unchanged from original (local mock)
//   const aiGenerate = () => {
//     setGenerating(true);
//     setTimeout(() => {
...
//   // â”€â”€ Submit â†’ createJob API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
//       setForm(empty);
//       setStep(0);
//       // Notify dashboard â€” it will show the toast and reload jobs
//       onSuccess();
//     } catch (err) {
...
//             {/* â”€â”€ Step 0: Basics â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
//             {step === 0 && (
//               <Stack spacing={2}>
...
//             {/* â”€â”€ Step 1: Details â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
//             {step === 1 && (
//               <Stack spacing={2}>
//                 <Grid container spacing={2}>
//                   <Grid item xs={4}>
...
//             {/* â”€â”€ Step 2: Requirements â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
//             {step === 2 && (
//               <Stack spacing={2}>
//                 <Box>
...
//             {/* â”€â”€ Step 3: Review â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
//             {step === 3 && (
//               <Stack spacing={1}>
//                 <Typography variant="h6">{form.title || "Untitled role"}</Typography>
//                 <Typography color="text.secondary">{form.company} Â· {form.location} Â· {form.workMode}</Typography>
//                 <Divider sx={{ my: 2 }} />
...
//           {/* â”€â”€ Live preview (unchanged) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
...
//                 <Chip size="small" label={form.urgency} sx={{ bgcolor: alpha("#7c3aed", 0.12), color: "primary.main" }} />
//               </Stack>
            ...
            {step === 2 && (
              <Stack spacing={2}>
                <Box>
                  ...
                  <Stack direction="row" spacing={1}>
                    <TextField
                      size="small" placeholder="Add a skillâ€¦" value={skillInput} fullWidth
            ...
            {step === 3 && (
              <Stack spacing={1}>
                ...
                <Typography color="text.secondary">
                  {form.company} Â· {form.location} Â· {form.category} Â· {form.employmentType}
                </Typography>
                <Divider sx={{ my: 2 }} />
                <Typography variant="body2" sx={{ whiteSpace: "pre-line" }}>{form.description}</Typography>
                <Typography variant="subtitle2" sx={{ mt: 2 }}>Responsibilities</Typography>
